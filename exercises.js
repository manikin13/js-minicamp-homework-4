...
function sumArray(numbers, cb) {
	...
	var arraySum = numbers.reduce(function(runningTotal, num){
...
function addReverseString() {
	//add  method to the string constructor's prototype that returns a reversed copy of the string
